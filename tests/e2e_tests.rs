...
use cross_platform::platform_consistency::{CrossPlatformTester, CrossPlatformResults};
use regression::regression_tests::{RegressionTestSuite, RegressionResults, LoadTestConfig};
use stress::load_tests::{LoadTestSuite, LoadTestResults};
...
impl E2ETestSuite {
    ...
    async fn execute_all_tests(&self) -> E2ETestResults {
        ...
        // Phase 3: Load and stress testing
        if self.config.enable_load_tests {
            println!("⚡ Phase 3: Load and stress testing");
