//! SP1 guest program for zkTLS verification
//! 
//! This program runs inside the SP1 zkVM and performs complete zkTLS verification
//! using the shared business logic from the zktls-zkvm crate.
